# The name of this view in Looker is "Project Polaris Ai Ds Me Mql Funnel"
view: project_polaris_ai_ds_me_mql_funnel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `project_polaris_ai_ds.ME_MQL_Funnel` ;;
  ...
  dimension_group: inquiry_quarter {
    type: time
  ...
  measure: count {
    type: count
    drill_fields: [sfdc_campaign_name]
  }
}
